...
```sh
curl https://raw.githubusercontent.com/massimans/nanorc/master/install.sh | sh
```

If your machine doesn't have `curl` command, use this code:

```sh
wget https://raw.githubusercontent.com/massimans/nanorc/master/install.sh -O- | sh
```
...
`git clone git@github.com:massimans/nanorc.git $install_path` or  
`git clone https://github.com/massimans/nanorc.git $install_path`

For system wide, run:

`sudo git clone https://github.com/massimans/nanorc.git $install_path`
...
This is reported in [Issue 52](https://github.com/massimans/nanorc/issues/52).
